    ...
    return (
        <section>
            ...
            <Paragraph size="md" className={Margins.bottom20}>
                HeinoDiscord can use a self-hosted cloud integration for settings sync across devices.
        ...
        <section>
            ...
            <Flex flexDirection="column" gap="1em">
                <FormSwitch
                    ...
                    description="Save your HeinoDiscord settings to the cloud so you can easily keep them the same on all your devices"
