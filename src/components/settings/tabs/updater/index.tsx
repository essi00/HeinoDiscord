...
function VesktopSection() {
    ...
    return (
        <Flex className={Margins.bottom20} flexDirection="column" gap="1em">
            <Card variant="info">
                <HeadingSecondary>Vesktop & HeinoDiscord</HeadingSecondary>
                <Paragraph>Vesktop and HeinoDiscord are two separate things. This updater is for HeinoDiscord.</Paragraph>
    ...
    return (
        <SettingsTab>
            ...
            <FormSwitch
                ...
                description="Automatically update HeinoDiscord without confirmation prompt"
                value={settings.autoUpdate}
                onChange={(v: boolean) => settings.autoUpdate = v}
            />
            <FormSwitch
                title="Get notified when an automatic update completes"
                description="Show a notification when HeinoDiscord automatically updates"
