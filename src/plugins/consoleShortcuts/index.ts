...
function makeShortcuts() {
    ...
    return {
        ...
        wpPatcher: { getter: () => HeinoDiscord.WebpackPatcher },
        wpInstances: { getter: () => HeinoDiscord.WebpackPatcher.allWebpackInstances },
        wpsearch: search,
        wpex: extract,
        ...
        PluginsApi: { getter: () => HeinoDiscord.Plugins },
        plugins: { getter: () => HeinoDiscord.Plugins.plugins },
        Settings: { getter: () => Vencord.Settings },
        Api: { getter: () => HeinoDiscord.Api },
